...
- [x] **Unit 1: Establish a reusable lightbox DOM and CSS contract**
...
- [x] **Unit 2: Extract a generic zoom target and collection model**
...
- [x] **Unit 3: Implement the reusable contained lightbox controller**
...
- [x] **Unit 4: Integrate the gallery adapter**
...
- [x] **Unit 5: Add a standalone single-image prototype surface**
...
- [x] **Unit 6: Wire lifecycle, viewport updates, and focused Playwright coverage**
